    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='Enter the project name', on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='taskmanager.Profile', verbose_name='name')),
            ],
            options={
